 ...
 */
public class NubeFragment52 extends Fragment {
    ...
    public NubeFragment52() {
        // Required empty public constructor
    }

    @SuppressLint("ValidFragment")
    public NubeFragment52(String cod_local, Context context) {
...
//        });
    ...
    public void cargaData(){
        ...
        try {
            ...
            data.open();
            asistentes = data.getAllNubeAsistentes52(cod_local);
