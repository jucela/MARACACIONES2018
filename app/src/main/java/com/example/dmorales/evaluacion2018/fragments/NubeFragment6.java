 ...
 */
public class NubeFragment6 extends Fragment {
    ...
    public NubeFragment6() {
        // Required empty public constructor
    }

    @SuppressLint("ValidFragment")
    public NubeFragment6(String cod_local, Context context) {
...
//        });
    ...
    public void cargaData(){
        ...
        try {
            ...
            data.open();
            asistentes = data.getAllNubeAsistentes6(cod_local);
