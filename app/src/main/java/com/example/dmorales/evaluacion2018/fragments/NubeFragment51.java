 ...
 */
public class NubeFragment51 extends Fragment {
    ...
    public NubeFragment51() {
        // Required empty public constructor
    }

    @SuppressLint("ValidFragment")
    public NubeFragment51(String cod_local, Context context) {
...
//        });
    ...
    public void cargaData(){
        ...
        try {
            ...
            data.open();
            asistentes = data.getAllNubeAsistentes51(cod_local);
