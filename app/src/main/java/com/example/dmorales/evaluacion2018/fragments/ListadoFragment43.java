 ...
 */
public class ListadoFragment43 extends Fragment {
    ...
    public ListadoFragment43() {
        // Required empty public constructor
    }


    @SuppressLint("ValidFragment")
    public ListadoFragment43(String usuario,String cod_local, Context context) {
        ...
        fabUpLoad.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    data.open();
                    asistentes1 = data.getAllEstado1Asistentes43();
                    asistentes2 = data.getAllEstado2Asistentes43();
                    data.close();
                } catch (IOException e) {
                    e.printStackTrace();
                }
                            ...
                            batch.commit().addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    ...
                                    try {
                                        ...
                                        data.actualizarAsistencia43(c, contentValues);
                                        cargaData();
...
//                recyclerView.setAdapter(registradoAdapter1);
    ...
    public void cargaData(){
        ...
        try {
            ...
            data.open();
            asistentes = data.getAllAsistentes43(cod_local);
