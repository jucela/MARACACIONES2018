 ...
 */
public class NubeFragment54 extends Fragment {
    ...
    public NubeFragment54() {
        // Required empty public constructor
    }

    @SuppressLint("ValidFragment")
    public NubeFragment54(String cod_local, Context context) {
...
//        });
    ...
    public void cargaData(){
        ...
        try {
            ...
            data.open();
            asistentes = data.getAllNubeAsistentes54(cod_local);
