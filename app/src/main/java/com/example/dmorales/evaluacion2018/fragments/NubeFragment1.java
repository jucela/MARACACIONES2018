 ...
 */
public class NubeFragment1 extends Fragment {
    ...
    public NubeFragment1() {
        // Required empty public constructor
    }

    @SuppressLint("ValidFragment")
    public NubeFragment1(String cod_local, Context context) {
...
//        });
    ...
    public void cargaData(){
        ...
        try {
            ...
            data.open();
            asistentes = data.getAllNubeAsistentes1(cod_local);
