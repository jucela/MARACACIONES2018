 ...
 */
public class NubeFragment53 extends Fragment {
    ...
    public NubeFragment53() {
        // Required empty public constructor
    }

    @SuppressLint("ValidFragment")
    public NubeFragment53(String cod_local, Context context) {
...
//        });
    ...
    public void cargaData(){
        ...
        try {
            ...
            data.open();
            asistentes = data.getAllNubeAsistentes53(cod_local);
