 ...
 */
public class NubeFragment42 extends Fragment {
    ...
    public NubeFragment42() {
        // Required empty public constructor
    }

    @SuppressLint("ValidFragment")
    public NubeFragment42(String cod_local, Context context) {
...
//        });
    ...
    public void cargaData(){
        ...
        try {
            ...
            data.open();
            asistentes = data.getAllNubeAsistentes42(cod_local);
