 ...
 */
public class ListadoFragment6 extends Fragment {
    ...
    public ListadoFragment6() {
        // Required empty public constructor
    }


    @SuppressLint("ValidFragment")
    public ListadoFragment6(String cod_local, Context context) {
        ...
        fabUpLoad.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    data.open();
                    asistentes1 = data.getAllEstado1Asistentes6();
                    data.close();
                } catch (IOException e) {
                    e.printStackTrace();
                }
                if(asistentes1.size() > 0){
                    ...
                    for (final AsistenteModelo2 asistenteModelo2 : asistentes1){
                        if(asistenteModelo2.getSubido1()==0) {
                            ...
                            DocumentReference documentReference = db.collection(coleccion).document(asistenteModelo2.get_id());
                            ...
                            batch.update(documentReference,"estatus1",asistenteModelo2.getEstatus1());
                            ...
                            batch.commit().addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    ...
                                    try {
                                        ...
                                        data.actualizarAsistencia6(c, contentValues);
                                        cargaData();
...
//                recyclerView.setAdapter(registradoAdapter1);
    ...
    public void cargaData(){
        ...
        try {
            ...
            data.open();
            asistentes = data.getAllAsistentes6(cod_local);
