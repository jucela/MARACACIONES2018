 ...
 */
public class ListadoFragment42 extends Fragment {
    ...
    public ListadoFragment42() {
        // Required empty public constructor
    }


    @SuppressLint("ValidFragment")
    public ListadoFragment42(String usuario,String cod_local, Context context) {
        ...
        fabUpLoad.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    data.open();
                    asistentes1 = data.getAllEstado1Asistentes42();
                    asistentes2 = data.getAllEstado2Asistentes42();
                    data.close();
                } catch (IOException e) {
                    e.printStackTrace();
                }
                            ...
                            batch.commit().addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    ...
                                    try {
                                        ...
                                        data.actualizarAsistencia42(c, contentValues);
                                        cargaData();
...
//                recyclerView.setAdapter(registradoAdapter1);
    ...
    public void cargaData(){
        ...
        try {
            ...
            data.open();
            asistentes = data.getAllAsistentes42(cod_local);
