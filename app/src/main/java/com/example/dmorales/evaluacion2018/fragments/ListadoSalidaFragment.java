 ...
 */
public class ListadoSalidaFragment extends Fragment {
    ...
    public ListadoSalidaFragment() {
        // Required empty public constructor
    }


    @SuppressLint("ValidFragment")
    public ListadoSalidaFragment(String sede, Context context) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_listadosalida, container, false);
        recyclerView = (RecyclerView) rootView.findViewById(R.id.listadosalida_recycler);
        fabUpLoad = (FloatingActionButton) rootView.findViewById(R.id.listadosalida_btnUpload);
        txtNumero = (TextView) rootView.findViewById(R.id.listadosalida_txtNumero);
        return rootView;
    }
            ...
            public void onClick(View v) {
                ...
                if(agregados.size() > 0){
                    ...
                    for (final Registrado registrado : agregados){
                        ...
                        String anio = registrado.getSanio();
                        final String c = registrado.getCodigo();
                        Toast.makeText(context, "Subiendo...", Toast.LENGTH_SHORT).show();
                        db.collection(fecha).document(registrado.getCodigo()).update("estado1",5)
