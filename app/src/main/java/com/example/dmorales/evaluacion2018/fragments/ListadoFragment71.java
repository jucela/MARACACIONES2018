 ...
 */
public class ListadoFragment71 extends Fragment {
    ...
    public ListadoFragment71() {
        // Required empty public constructor
    }


    @SuppressLint("ValidFragment")
    public ListadoFragment71(String usuario,String cod_local, Context context) {
        ...
        fabUpLoad.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    data.open();
                    asistentes1 = data.getAllEstado1Asistentes71();
                    asistentes2 = data.getAllEstado2Asistentes71();
                    data.close();
                } catch (IOException e) {
                    e.printStackTrace();
                }
                            ...
                            batch.commit().addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    ...
                                    try {
                                        ...
                                        data.actualizarAsistencia71(c, contentValues);
                                        cargaData();
...
//                recyclerView.setAdapter(registradoAdapter1);
    ...
    public void cargaData(){
        ...
        try {
            ...
            data.open();
            asistentes = data.getAllAsistentes71(cod_local);
