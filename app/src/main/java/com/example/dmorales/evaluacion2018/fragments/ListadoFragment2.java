 ...
 */
public class ListadoFragment2 extends Fragment {
    ...
    public ListadoFragment2() {
        // Required empty public constructor
    }


    @SuppressLint("ValidFragment")
    public ListadoFragment2(String usuario,String cod_local, Context context) {
        ...
        fabUpLoad.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    data.open();
                    asistentes1 = data.getAllEstado1Asistentes2();
                    asistentes2 = data.getAllEstado2Asistentes2();
                    data.close();
                } catch (IOException e) {
                    e.printStackTrace();
                }
                if(asistentes1.size() > 0){
                    ...
                    for (final AsistenteModelo1 asistenteModelo1 : asistentes1){
                        if(asistenteModelo1.getSubido1()==0 && asistenteModelo1.getSubido2()==0) {
                            ...
                            String coleccion2 = "NIVELIyIIA";
                            WriteBatch batch = db.batch();
                            DocumentReference documentReference = db.collection(coleccion).document(coleccion2).collection("asistentes").document(asistenteModelo1.get_id());
                            ...
                            batch.update(documentReference,"estatus_registro1",asistenteModelo1.getEstatus1());
                            ...
                            batch.commit().addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    ...
                                    try {
                                        ...
                                        data.actualizarAsistencia2(c, contentValues);
                                        cargaData();
...
//                recyclerView.setAdapter(registradoAdapter1);
    ...
    public void cargaData(){
        ...
        try {
            ...
            data.open();
            asistentes = data.getAllAsistentes2(cod_local);
